...
//       <div className="max-w-[90%] lg:max-w-[80%] mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
//         {/* LEFT CONTENT */}
//         <motion.div
...
export default function Hero() {
  return (
    <section className="w-full text-white relative overflow-hidden font-inter">
      <div className="max-w-[95%] sm:max-w-[90%] lg:max-w-[85%] xl:max-w-[80%] mx-auto px-4 sm:px-6 lg:px-10 py-6 sm:py-6 lg:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-extrabold leading-tight">
            Grow Your Business <br className="hidden lg:block" /> Visibility Everywhere <br className="hidden lg:block" />
            People Search
          </h1>
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1.1, duration: 0.6 }}
        className="flex justify-center pb-10 sm:pb-14 lg:pb-16"
      >
