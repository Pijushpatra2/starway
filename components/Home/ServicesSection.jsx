      ...
      <div className="w-full lg:w-[85%] xl:w-[80%] 2xl:w-[70%] mx-auto px-4 relative">
        ...
        <div className="block sm:hidden">
          ...
          <div className="grid grid-cols-2 gap-4">
            <ServiceCardMobile icon={Video} title="Video editing" />
            <ServiceCardMobile icon={PenTool} title="Content Marketing" />
            <ServiceCardMobile icon={Share2} title="Social Media" />
            <ServiceCardMobile icon={MousePointerClick} title="PPC Ads" />
            <ServiceCardMobile icon={BarChart3} title="SEO Optimization" />
            <ServiceCardMobile icon={Code2} title="Website Design" />
          </div>
        </div>
        ...
        <div className="hidden sm:block">
          ...
          <div className="hidden lg:flex justify-center mt-12 lg:mt-0 lg:absolute lg:-bottom-40 lg:left-1/2 lg:-translate-x-1/2">
            <button className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 lg:w-40 lg:h-40 group">
              {/* Circular Text */}
              <svg
                viewBox="0 0 200 200"
