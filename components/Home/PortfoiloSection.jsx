  ...
  branding: [
    {
      ...
      image: "/modern-tech-startup-logo-brand-identity.jpg",
  ...
  web: [
    {
      ...
      image: "/modern-ecommerce-website-shopping-interface.jpg",
    ...
    },
    {
      ...
      image: "/saas-dashboard-analytics-interface-dark-mode.jpg",
    ...
    },
    {
      ...
      image: "/mobile-banking-app-interface-modern.jpg",
                    ...
                    {projectsData[activeTab].map((project) => (
                      ...
                      >
                        ...
                        {/* <div className="p-6">
                          ...
                          <h4 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-pink-600 group-hover:bg-clip-text transition-all">
                            {project.title}
                          </h4>
                          ...
                          {project.results && (
                            <motion.div
                              ...
                              className="mb-4 inline-block px-3 py-2 bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg"
                            >
                              <p className="text-xs font-semibold text-green-700 flex items-center gap-1">
                                <Sparkles className="w-3 h-3" /> {project.results}
                              </p>
                            </motion.div>
                          )}
