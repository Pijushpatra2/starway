      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              {Icon && (
                <div className="w-20 h-20 rounded-2xl bg-blue-700/20 backdrop-blur-sm flex items-center justify-center mb-8">
              ...
              <form className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="flex-1 px-8 py-4 bg-primary
                  ...
                  {secondaryCta && (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      type="button"
                      className="flex-1 px-8 py-4 text-destructive bg-gray-100
