    ...
    plans: [
      {
        ...
        description: 'Perfect for startups and small businesses looking to establish their visual presence.',
        price: '$2,499',
      ...
      },
      {
        ...
        description: 'For growing businesses ready to scale with a professional brand identity.',
        price: '$4,999',
        billing: 'One-time project',
        popular: true,
      ...
      },
      {
        ...
        description: 'Comprehensive branding solution for established businesses and enterprises.',
        price: 'Custom',
  ...
  ai: {
    ...
    plans: [
      ...
      },
      {
        ...
        description: 'Comprehensive optimization across all major AI platforms.',
        price: '$2,499/mo',
        billing: 'Monthly subscription',
        popular: true,
...
export default function Pricing() {
  ...
  const activePlans = plansData[activeService]?.plans || plansData.ai.plans;

  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-b from-white to-blue-50/30">
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-blue-100 to-transparent rounded-full -translate-y-48 translate-x-48"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-cyan-100 to-transparent rounded-full translate-y-48 -translate-x-48"></div>
        
        <div className="relative w-[90%] max-w-7xl mx-auto py-20">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 rounded-full mb-6">
              <Sparkles className="text-blue-600" size={16} />
              <span className="text-blue-600 font-medium">Transparent Pricing</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Flexible Plans for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Every Stage</span> of Growth
            </h1>
            
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10 leading-relaxed">
              Choose the right plan for your business — from startups to scaling brands. 
              No hidden fees, just clear value.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl flex items-center gap-3 text-lg font-bold text-white hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300">
                Compare All Plans
      ...
      <div className="w-[90%] max-w-4xl mx-auto py-12">
        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">How Our Pricing Works</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our plans are organized by service. Select a service to view tailored plans designed 
            for your specific goals and growth stage. Each service includes three tiers to match your needs.
          </p>
        </div>
      </div>
      ...
      <div className="w-[90%] max-w-7xl mx-auto py-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className={`mt-3 text-sm font-medium ${
                      activeService === service.id ? 'text-blue-600' : 'text-gray-500 group-hover:text-blue-500'
                    }`}>
                      View plans →
                    </div>
                  </div>
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex bg-gray-100 p-1 rounded-xl">
            ...
            >
              Yearly Billing <span className="text-green-600 text-sm ml-1">(Save 20%)</span>
            </button>
          </div>
        </div>
              ...
              <div className="p-8">
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    {plan.popular && <Star className="text-yellow-400 fill-yellow-400" size={20} />}
                  </div>
                  <p className="text-lg font-bold text-gray-900 mb-1">{plan.price}</p>
                  <p className="text-gray-500 text-sm mb-4">{plan.billing}</p>
                  ...
                  {plan.features.map((feature, idx) => (
                    <div key={idx} className="flex items-start gap-3">
                      {feature.included ? (
                        ...
                        <X className="text-gray-300 mt-1 flex-shrink-0" size={18} />
                      )}
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50">
                  <th className="p-6 text-left text-gray-900 font-bold">Features</th>
                  {activePlans.map((plan, index) => (
                  ...
                  <tr key={rowIndex} className={rowIndex % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    {activePlans.map((plan, planIndex) => (
                      <td key={planIndex} className="p-6 text-center">
                        {rowIndex === 0 && plan.features[0]?.included && (
                        ...
                        {rowIndex === 1 && (
                          <span className="text-gray-700 font-medium">
                            {plan.name === 'Starter' ? 'Basic' : 
                             plan.name === 'Growth' ? 'Advanced' : 'Full'}
                          </span>
                        )}
                        {rowIndex === 2 && (
                          <span className="text-gray-700 font-medium">
                            {plan.name === 'Starter' ? 'Monthly' : 
                             plan.name === 'Growth' ? 'Bi-weekly' : 'Weekly + Live'}
                          </span>
                        )}
                        {rowIndex === 3 && (
                          <span className="text-gray-700 font-medium">
                            {plan.name === 'Starter' ? 'Email' : 
                             plan.name === 'Growth' ? 'Priority' : 'Dedicated'}
                          </span>
                        )}
                        {rowIndex === 4 && (
                          <span className="text-gray-700 font-medium">
                            {plan.name === 'Starter' ? '48h' : 
                             plan.name === 'Growth' ? '24h' : '4h'}
                          </span>
                        )}
                        {rowIndex === 5 && (
                          <span className={`font-medium ${
                            plan.name === 'Starter' ? 'text-gray-400' : 
                            plan.name === 'Growth' ? 'text-green-600' : 'text-green-600'
                          }`}>
                            {plan.name === 'Starter' ? 'No' : 
                             plan.name === 'Growth' ? 'Partial' : 'Full'}
                          </span>
                        )}
                      </td>
                    ))}
        ...
        <div className="bg-gradient-to-r from-blue-600 to-cyan-500 rounded-3xl p-12 mb-20 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">
              We create tailored growth plans combining multiple services based on your specific goals, 
              timeline, and budget. Perfect for enterprises and businesses with unique requirements.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                answer: "It depends on the service. Most marketing services (SEO, PPC, Social) are monthly subscriptions. Design and development are typically one-time project fees."
              },
              {
                question: "Do you offer custom pricing?",
                answer: "Absolutely. For enterprises or businesses needing multiple services combined, we create custom packages with tailored pricing."
              },
              {
                question: "What if I need multiple services?",
                answer: "We offer bundled pricing for multiple services. Contact our sales team for a custom package that saves you 15-25% compared to individual services."
              },
              {
                question: "Is there a minimum commitment?",
                answer: "For monthly services, we require a 3-month minimum commitment to ensure we can deliver meaningful results. Project-based services have no minimum."
              },
              {
                question: "Do you offer refunds?",
                answer: "Yes, we offer a 14-day money-back guarantee for monthly services. Project-based work includes milestone-based payments with satisfaction guarantees."
              }
            ].map((faq, index) => (
        ...
        <div className="text-center bg-gradient-to-b from-white to-blue-50 rounded-3xl p-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10">
            Schedule a free consultation with our experts. We'll analyze your needs and recommend 
            the perfect plan to achieve your goals.
          </p>
          ...
          <div className="mt-10 text-gray-500">
            <p className="text-sm">Free consultation includes: Strategy review + Plan recommendation + Custom quote</p>
